...
export type LogoInterbankProps = React.SVGProps<SVGSVGElement> & {
    className?: string;
    title?: string;
    fillPrimary?: string;
...
const LogoInterbank: React.FC<LogoInterbankProps> = ({
    className,
    title = "El tiempo vale mas que el dinero",
    fillPrimary = "#05BE50",
    fillSecondary = "#0039A6",
    ...props
}) => {
    return (
        <svg
        ...
        >
            ...
            <path
                ...
                fillRule="evenodd"
                clipRule="evenodd"
                d="M3.8 0C1.8 0 0 1.9 0 3.9v24.3h24c2.1 0 3.8-1.7 3.8-3.8V.1H3.8zm17.6 20.3L6.6 23V8l14.8-2.8v15z"
                fill={fillSecondary}
            />
        </svg>
    );
